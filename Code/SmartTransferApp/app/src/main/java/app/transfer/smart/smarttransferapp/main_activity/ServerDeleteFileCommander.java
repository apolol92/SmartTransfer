 ...
 */
public class ServerDeleteFileCommander extends AsyncTask<Void,Void,Void> {
    private byte[] data;
    private Integer lastId;
    private WlanServer wlanServer;
    private Command serverResponse;

    public ServerDeleteFileCommander(WlanServer wlanServer, Integer lastId, byte[] data) {
    ...
    protected Void doInBackground(Void... params) {
        Command loginCmd = CommandFactory.createCommand(this.lastId, "USER", 2, "none", "none", new byte[1]);
