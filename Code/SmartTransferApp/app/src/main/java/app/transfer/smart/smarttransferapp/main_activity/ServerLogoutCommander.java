 ...
 */
public class ServerLogoutCommander extends AsyncTask<Void,Void,Void> {
    private byte[] data;
    private Integer lastId;
    private WlanServer wlanServer;
    private Command serverResponse;

    public ServerLogoutCommander(WlanServer wlanServer, Integer lastId, byte[] data) {
    ...
    protected Void doInBackground(Void... params) {
        Command loginCmd = CommandFactory.createCommand(this.lastId, "USER", 8, "none", "none", new byte[1]);
