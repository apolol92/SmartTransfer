 ...
 */
public class ServerKeepAliveCommander extends AsyncTask<Void,Void,Void> {

    private Integer lastId;
    private WlanServer wlanServer;
    private Command serverResponse;

    public ServerKeepAliveCommander(WlanServer wlanServer, Integer lastId) {
    ...
    protected Void doInBackground(Void... params) {
        Command loginCmd = CommandFactory.createCommand(this.lastId, "USER", 3, "none", "none", new byte[1]);
