 ...
 */
public class ServerDownloadDataCommander  extends AsyncTask<Void,Void,Void> {
    private byte[] data;
    ...
    protected Void doInBackground(Void... params) {
        Command loginCmd = CommandFactory.createCommand(this.lastId, "USER", 0, "none", "none", new byte[1]);
