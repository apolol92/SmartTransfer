package app.transfer.smart.smarttransfer.crypto;
...
/**
 * Created by apolol92 on 28.12.2015.
 */
public class Crypter {
    ...
    public static byte[] Encrypt(String plainText, String KEY) {
        ...
        try {
            byte[] encryptedData = encrypt(plainText.getBytes(),KEY.getBytes(),iv);
    ...
    public static String Decrypt(byte[] encryptedText, String KEY) {
        ...
        AlgorithmParameterSpec parameterSpec = new IvParameterSpec(iv);
        try {
            return new String(decrypt(encryptedText,KEY.getBytes(),iv),"UTF-8");
        } catch (NoSuchAlgorithmException e) {
            e.printStackTrace();
        } catch (NoSuchPaddingException e) {
            e.printStackTrace();
